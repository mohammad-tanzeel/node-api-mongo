...
//    });
    ...
    //Delete Many
//    db.collection('Todos').deleteMany({text:'Andrew'}).then((result) => {
//        console.log(result);
//    });
  
    //Delete One
//    db.collection('odos').deleteOne({text:'Andrew'}).then((result) => {
//        console.log(result);
//    });

//   Find and Delete
    db.collection('Todos').findOneAndDelete({complete:'Yes'}).then((result) => {
        console.log(result);
    })
    db.close();
});  